...
import com.ceiba.biblioteca.dominio.excepcion.*;
...
public class ManejadorError extends ResponseEntityExceptionHandler{
    ...
    public ManejadorError() {
        ...
        CODIGOS_ESTADO.put(ExcepcionTipoUsario.class.getSimpleName(), HttpStatus.BAD_REQUEST.value());
        CODIGOS_ESTADO.put(ExcepcionPrestamoActivo.class.getSimpleName(), HttpStatus.BAD_REQUEST.value());
        CODIGOS_ESTADO.put(ExcepcionIdNoExiste.class.getSimpleName(), HttpStatus.BAD_REQUEST.value());
    }
    ...
    public final ResponseEntity<Error> handleAllExceptions(Exception exception) {
        ...
        if (codigo != null) {
            ...
            Error error = new Error(OCURRIO_UN_ERROR_FAVOR_CONTACTAR_AL_ADMINISTRADOR);
